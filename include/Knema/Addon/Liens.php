<?php
   ...
   * Rassemble des liens
   */
class Knema_Addon_Liens extends Knema_Addon implements Iterator, Countable
{
	protected $liens;
	protected $id;
	protected $titre;
	...
	protected function lien($metas, array $urlOptions, array $acl, $reset)
	{
		if (!$metas)
			return false;
		...
		if ($acl && count($acl) > 2 && is_null($acl[0])) {
