...
class Client(object):
    ...
    def select(self, selector, value):
        self.find(selector).select_by_value(value)

    def submit(self):
        return self.click('#document button[type=submit]')
    ...
    def save(self, filename):
        open(filename, 'w').write(self.driver.page_source)
...
class ClientTestCase(unittest.TestCase):
    ...
    et la page HTML courante en cas d'erreur.  """
